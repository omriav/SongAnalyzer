...
from Scrapper.DataHandlers import elastic_handler
from Scrapper.SpidersConfiguration.shironet_config import shironet_config
...
class ShironetSpider(scrapy.Spider):
    ...
    def parseArtistPage(self, response):
        ...
        print("Artist {0} all pages ended".format(response.meta["artist_name"]))
...
cmdline.execute("scrapy runspider shironet_spider.py --nolog".split())
